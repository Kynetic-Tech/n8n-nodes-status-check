...
export class StatusCheckCreditsDepletedTrigger implements INodeType {
		...
		properties: [
			{
				...
				name: 'webhookName',
				type: 'string',
				default: 'n8n Credits Depleted Alert',
				required: true,
			...
			},
			{
				...
				name: 'description',
				type: 'string',
				default: 'Urgent alert when credits are exhausted',
	...
	async webhook(this: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		const eventType = bodyData.event || 'credits.depleted';
